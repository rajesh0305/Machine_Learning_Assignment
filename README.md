...
### Algorithms And DataStructure [GeeksforGeeks]([https://leetcode.com/sammorozov/](https://www.geeksforgeeks.org/user/rajeshrajput/))
...
| Pytorch | TensorFlow | Numpy | Pandas | Sklearn | OpenCV |
|----------|----------|----------|----------|----------|----------|
...
| nodejs | Git | Docker | AWS | Swagger | P| VBox | HardHat |
|----------|----------|----------|----------|----------|----------|----------|----------|
